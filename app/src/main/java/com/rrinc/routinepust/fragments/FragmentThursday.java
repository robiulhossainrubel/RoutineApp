...
public class FragmentThursday extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView =(RecyclerView) view.findViewById(R.id.thursday_recy);
    ...
    private void readThu(String Dep, String Sem) {
        ...
        reference= FirebaseDatabase.getInstance().getReference("Routine").child(Dep).child(Sem).child("thu");
